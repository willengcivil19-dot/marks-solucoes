  ...
  return (
    <section id="art-reforma" className="bg-white py-16 sm:py-20">
      <Container className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:gap-16">
        <Reveal>
          <SectionHeading eyebrow="Uma situação comum" title="Quer começar a reforma, mas não sabe se precisa de ART?" />
        </Reveal>
        <Reveal delay={100}>
          <div className="space-y-4 text-base leading-relaxed text-[#475569]">
            <p>
              Isso é comum em apartamentos, casas, escritórios e imóveis comerciais — seja porque o condomínio
              exige, seja porque a própria reforma envolve intervenções que pedem responsabilidade técnica.
            </p>
            <p>
